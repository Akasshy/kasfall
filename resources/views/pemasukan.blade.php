          ...
          <div class="container px-6 mx-auto grid">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                      ...
                      <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                          <div class="flex items-center text-sm text-center">
                            <div>
                              <p class="font-semibold fs-7" >{{$item->siswa->nama }}</p>
                            </div>
                          </div>
                        </td>
                        ...
                        <td class="px-4 py-3">
                          <div class="flex items-center space-x-4 text-sm">
                            <a href="/update-pemasukan/{{$item->id}} "
                            ...
                            <a href="/pemasukan/delete/{{$item->id}}" onclick="return window.confirm('Yakin hapus data ini?')"
                              class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                              aria-label="Delete"
                            >
                              <svg
              ...
              {{-- <form action="/pemasukan" method="post">
                ...
                placeholder="Cari berdasarkan nama dan tanggal"
                aria-label="Search"
                style=" width: 485px; margin-left: 500px"
                />
                <button class="btn text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple " style="height: 40px;">Cari</button>
